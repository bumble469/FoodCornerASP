<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Beverages.aspx.cs" Inherits="FoodWebsite.Beverages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">
    <div class="container item-container">
        <div class="row">
            ...
            <div class="col-lg-6"><h2 id="menu-categories-title" class="text-center">Beverages Menu</h2></div>
        </div>
        <div class="row">
